...
const getDrawerIcon = (routeName: string) => {
    ...
    switch (routeName) {
        case Utils.screens.HOME_STACK:
            return <FontAwesome5 name='cash-register' size={iconSize} color={'black'} />; // Home icon
        case Utils.screens.ORDER_STACK:
            return <Entypo name='documents' size={iconSize} color={'black'} />; // Order icon
        case Utils.screens.FEL:
            return <MaterialDesignIcons name='book-check-outline' size={iconSize} color={'black'} />
        ...
        case Utils.screens.BACKUP:
            return <MaterialDesignIcons name='backup-restore' size={iconSize} color={'black'} />; // Maintenance icon
    ...
    return (
        <>
            ...
            >
                ...
                <Drawer.Screen name={Utils.screens.BACKUP} component={MaintenanceStack} options={options} />
                <Drawer.Screen name={Utils.screens.EDIT_LIST_PRODUCT_STACK} component={EditProductNavigator} options={options} />
            </Drawer.Navigator>
        </>
