...
const StackNavigator = () => {
  ...
  return (
    <>
      <Stack.Navigator>
        <Stack.Screen
          name={Utils.screens.HOME}
          component={HomePage}
          options={options}
        />
        <Stack.Screen
          name={Utils.screens.MENU}
          component={MenuPage}
          options={options}
        />
        <Stack.Screen
          name={Utils.screens.EDIT_SHOPPING_CART}
          component={EditShoppingCartPage}
          options={options}
        />
        <Stack.Screen
          name={Utils.screens.PAYMENT}
          component={PayPage}
          options={options}
        />
        <Stack.Screen
          name={Utils.screens.FINISH_ORDER}
