...
const EditProductNavigator = () => {
    ...
    return (
        <>
            <Stack.Navigator>
                <Stack.Screen name={Utils.screens.EDIT_LIST_PRODUCT} component={EditListProducts} options={options} />
                <Stack.Screen name={Utils.screens.EDIT_PRODUCT} component={EditProduct} options={options} />
            </Stack.Navigator>
            <ToastComponent />
        </>
