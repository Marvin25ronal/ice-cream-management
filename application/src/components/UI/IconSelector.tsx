...
const IconSelector = ({
  ...
  switch (icon_class) {
    case type_class_icon.AntDesign:
      return <AntDesign size={size} name={icon} color={color} />;
    case type_class_icon.Entypo:
      return <Entypo size={size} name={icon} color={color} />;
    case type_class_icon.EvilIcons:
      return <EvilIcons size={size} name={icon} color={color} />;
    case type_class_icon.Feather:
      return <Feather size={size} name={icon} color={color} />;
    ...
    case type_class_icon.SimpleLineIcons:
      return <SimpleLineIcons size={size} name={icon} color={color} />;
    case type_class_icon.FontAwesome5:
      return <FontAwesome5Icon size={size} name={icon} color={color} />;
    case type_class_icon.Ionicons:
      return <Ionicons size={size} name={icon} color={color} />;
    case type_class_icon.Fontisto:
      return <Fontisto size={size} name={icon} color={color} />;
    case type_class_icon.FontAwesome:
      return <FontAwesome size={size} name={icon} color={color} />;
    default:
      return <AntDesign size={size} name={'warning'} color={color} />;
  }
};
