      ...
      <Animated.ScrollView style={styles.dashboardContainer}>
        <View style={[styles.rowContainer]}>
          <View style={[styles.card]}>
            <Text style={styles.indicatorText}>{orders.length}</Text>
            <Text style={styles.titleCard}>Número de órdenes</Text>
          </View>
          <View style={[styles.card]}>
            <Text style={styles.indicatorText}>{orderProduced}</Text>
            <Text style={styles.titleCard}>Órdenes procesadas</Text>
          </View>
          <View style={[styles.card]}>
            <Text style={[styles.indicatorText]}>{orderCard}</Text>
            <Text style={[styles.titleCard]}>Total con tarjeta</Text>
          </View>
          <View style={[styles.card]}>
            <Text style={[styles.indicatorText, { color: '#bc4749' }]}>
              {orderWithError}
            </Text>
            <Text style={styles.titleCard}>Órdenes con error</Text>
          </View>
        </View>
        <View style={styles.rowContainer}>
          <View style={[styles.card]}>
            ...
            <Text style={[styles.titleCard]}>Total de venta</Text>
          </View>
          <View style={[styles.card]}>
          ...
          <View style={[styles.card]}>
            ...
            <Text style={[styles.titleCard]}>Total en efectivo</Text>
          </View>
        </View>
        <View style={styles.rowContainer}>
          {loading == true && (
