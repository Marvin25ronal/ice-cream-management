  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.optionsContainer}>
        ...
        <TouchableOpacity
          style={[styles.card, { backgroundColor: theme.EDIT_BUTTON_COLOR }]}
          onPress={() => {
            printTicket();
          }}>
          <Text style={styles.cardText}>Imprimir Orden</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.card, { backgroundColor: theme.PAY_BUTTON_COLOR }]}
          onPress={() => {
            clearShoppingCart();
            navigation.navigate(Utils.screens.HOME, { reload: true });
          }}>
          <Text style={styles.cardText}>Finalizar compra</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
